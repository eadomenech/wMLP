...
\keywords{Handwritten  \and Image \and Neural network \and Watermarking.}
\end{abstract}
%
%
%
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{models.eps}
		\caption{Multilayer perceptron used.} \label{loss}
	\end{center}
\end{figure}
...
\begin{figure} [H]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{colormap.png}
